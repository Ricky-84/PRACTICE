# -*- coding: utf-8 -*-
"""
Created on Sun Jun  9 23:45:49 2024
...
def yellow_handle_moment(keys_pressed, yellow):
    ...
    if keys_pressed[pygame.K_w] and yellow.y-VEL > 0: #UP
        yellow.y -= VEL
    if keys_pressed[pygame.K_s] and yellow.y+VEL+yellow.height < HEIGHT -15 : #RIGHT: #DOWN
        yellow.y += VEL
     
def red_handle_moment(keys_pressed, red):
    if keys_pressed[pygame.K_LEFT] and red.x-VEL > BORDER.x+BORDER.width+15: #LEFT
        red.x -= VEL
    if keys_pressed[pygame.K_RIGHT] and red.x+VEL+red.width < WIDTH: #RIGHT: #RIGHT
        red.x += VEL
